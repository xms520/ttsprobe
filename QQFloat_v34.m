/*
 * QQFloat_v34.m — v3.4: sendPttMsg blocks 传 nil(绕 Swift witness 查表崩溃) + SIGTRAP 捕获
...
static void QQFloatV2Init(void) {
    ...
    TTLog(@"QQFloat v3.4 init (blocks nil + SIGTRAP guard)");
    ...
    TTLog(@"[qq-init] v3.4 hooks installed");
}
@end
