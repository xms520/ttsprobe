/*
 * QQFloat_v3.m — QQ 文字转语音插件（NT 内核直调方案 v3: QQMsgService 单例主动链）
...
- (void)sendDirect {
    ...
    if (!handler) {
        ...
        if (qmsInst && peer) {
            ...
            @try {
                id fresh = ((id (*)(id, SEL, id))objc_msgSend)(qmsInst, getS2, peer);
                if (fresh) {
...
static void QQFloatV2Init(void) {
    ...
    TTLog(@"QQFloat v3 init (QQMsgService 单例链 + 多点捕捉)");
    ...
    TTLog(@"[qq-init] v3 hooks installed");
}
@end
